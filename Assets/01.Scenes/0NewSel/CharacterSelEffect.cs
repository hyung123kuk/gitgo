...
{
    [SerializeField]
    List<RectTransform> Page = new List<RectTransform>(); // [0]-> ���������� ,[1] -> ĳ���͸����������, [2] ->ĳ���͸���� 2��°������
    [SerializeField]
    ...
    int character=-1; //0:������ 1:��ó 2:������
    [SerializeField]
    GameObject[] Characters; //0:������ 1:��ó 2:������
    [SerializeField]
    GameObject Ch_Effect;
    [SerializeField]
    RectTransform[] Ch_button; //0:������ 1:��ó 2:������
    [SerializeField]
    Image[] block;
    [SerializeField]
    ...
    public float pageSpeed=0.1f;//������ �ϳ��� �ϳ��� ����
    public float pageFlipSpeed = 0.02f; //������ �ѱ�� �ӵ�
    ...
    IEnumerator AbilltyFillAmount()
    {
        ...
        {
            yield return new WaitForSeconds(0.02f);
            if (attack < Abillity[character, 0]) //�ɷ�ġ ���� ä������ fillamount�� �ؽ�Ʈ �� �ö�
            {
                attack++;
