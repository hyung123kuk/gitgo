...
public class ChSelSkill : MonoBehaviour
{
    ...
    {
        chSelSkill = this;
        Aurapos = GameObject.Find("SelManager").transform.GetChild(1).
            GetChild(0).transform.GetChild(2).transform;
        arrowPos = GameObject.Find("SelManager").transform.GetChild(1).
           GetChild(1).transform.GetChild(2).transform;
        MagicPos = GameObject.Find("SelManager").transform.GetChild(1).
           GetChild(2).transform.GetChild(2).transform.GetChild(3).transform;
        Mage1SkillPos1 = GameObject.Find("SelManager").transform.GetChild(1).
           GetChild(2).transform.GetChild(2).transform.GetChild(0).transform;
        Mage1SkillPos2 = GameObject.Find("SelManager").transform.GetChild(1).
           GetChild(2).transform.GetChild(2).transform.GetChild(1).transform;
        Mage1SkillPos3 = GameObject.Find("SelManager").transform.GetChild(1).
        ...
        Mage2SkillEff = GameObject.Find("SelManager").transform.GetChild(1).
           GetChild(2).transform.GetChild(3).gameObject;
        Mage2SkillReadyEff = GameObject.Find("SelManager").transform.GetChild(1).
